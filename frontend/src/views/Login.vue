        ...
        <div class="w-1/2 h-screen bg-white p-8 flex flex-col justify-center items-center">
            <div class="w-full h-3/4 p-6 flex flex-col justify-center bg-white">
                ...
                <form @submit.prevent="handleLogin" class="space-y-4">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600">Ingresar</button>
                    <p @click="showModalRegisterOpen"
                        class="text-blue-500 text-sm font-semibold mt-4 block text-center hover:text-blue-700 cursor-pointer">
                        No tienes cuenta? Registrate</p>
                </form>
            </div>
        </div>
